        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-black/40 border border-white/10 rounded-lg py-3 pl-10 pr-4 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-primary transition-colors"
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center">
              ...
              <a
                href="#"
                className="text-xs text-primary hover:underline hover:text-green-400 transition-colors"
              >
                Forgot?
              </a>
            </div>
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-black/40 border border-white/10 rounded-lg py-3 pl-10 pr-10 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-primary transition-colors"
                disabled={isSubmitting || success}
              />
              <button
                type="button"
          ...
          <div className="flex items-center">
            <input
              id="remember-me"
              type="checkbox"
              className="h-4 w-4 accent-primary rounded bg-black/40 border-white/10 focus:ring-0 focus:ring-offset-0 focus:outline-none"
            />
            <label htmlFor="remember-me" className="ml-2.5 text-xs text-gray-400 select-none">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            type="submit"
            className="w-full py-3.5 mt-2 bg-primary text-black font-bold uppercase tracking-wider text-sm rounded-lg hover:bg-green-600 transition-colors duration-300 shadow-[0_0_20px_rgba(34,197,94,0.2)] hover:shadow-[0_0_30px_rgba(34,197,94,0.4)] flex items-center justify-center disabled:opacity-50"
            disabled={isSubmitting || success}
          >
            {isSubmitting ? (
